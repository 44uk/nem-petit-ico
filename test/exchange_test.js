...
const described = require('../lib/exchange.js');
...
//       return described.fetchMessageSents(
//         addr,
//         Date.parse('2015-03-29T00:06:25Z'),
//         mosaicFqn
//       ).then(results => {
...
//     ;
//
//     it('return a tx, sent a message', () => {
//       return described.fetchMessageSendings(
//         addr,
//         Date.parse('2015-03-29T00:06:25Z'),
//         mosaicFqn
//       ).then(results => {
